...
#	txt_footer += "var hoge = fifthColumn.labels().format(\"{%status}\");\n"
	txt_footer += "fifthColumn.labels().format( function (item) {var a = item.get('status');if(a==\"close\"){a=\"CLOSE\";}else if(a==\"DELAYED\"){a=\"DELAYED\";}return a;});\n"
	txt_footer += "var tooltip = dataGrid.tooltip();\n"
	txt_footer += "tooltip.format(\"{%description}\");\n"
	txt_footer += "chart.rowHoverFill('#FFFFCC');\n"
	txt_footer += "chart.rowSelectedFill('#FFFF00');\n"
